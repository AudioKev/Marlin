 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 2*60 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -41.00, -15.00, -2.40 }
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE         20.2  // (mm/s) Feedrate for XY Moves for the G26 Mesh Validation Tool.
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_HEIGHT      0.11  // (mm) Z height of nozzle at leveling points
  #define LEVEL_CORNERS_Z_HOP       4.00  // (mm) Z height of nozzle between leveling points
